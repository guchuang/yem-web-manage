...
@Slf4j
public class PreParamFilter {
	
	public static String preHandle(HttpServletRequest request) throws BaseException {
		...
		return JSONObject.toJSONString(baseMsg.getRequestBody());
	}
	 ...
	 * @since JDK 1.8
	 */
	public static String preHandlerRequest(HttpServletRequest request) throws BaseException{
	 ...
	 * @since JDK 1.8
	 */
	private static JSONObject parseHanlderRequest(String json) throws BaseException{
		JSONObject param;
		try {
	 ...
	 * @since JDK 1.8
	 */
	private static void checkBaseMsg(JSONObject json, BaseMsg msg) throws ParamException {
		if (json == null) {
